...
<div class="sidebar" id="mySidebar">
    <div class="side-header">
        <img src="./assets/images/pexels-photo-427547.webp" width="120" height="120" alt="Swiss Collection" style="width: 80px; height: 80px; border-radius: 100%; object-fit: cover; margin-left: 28px">
