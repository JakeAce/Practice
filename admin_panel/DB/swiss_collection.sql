...
(1, 2, 'Jake Ace', '9802234675', 'Matepani-12', 'Cash', 0, 0, '2022-04-10'),
...
(2, 'Pliers', 'Pliers are another essential tool used in motor repair and mechanical work. They are versatile tools that provide a strong grip for a wide range of tasks', './uploads/OIP (2).jpeg', 890, 1, '2022-04-04'),
(5, 'Hammers', 'A hammer is a tool used to strike objects—whether to loosen, install, remove, or shape parts. In motor repair, different types of hammers are used depending on the job.', './uploads/OIP (3).jpeg', 400, 14, '2022-04-04'),
(8, 'Wrenches', 'Wrenches are essential tools in motor repair and general mechanical work. They are used for tightening or loosening nuts, bolts, and other fasteners.', './uploads/OIP.jpeg', 900, 10, '2025-05-10'),
(9, 'Socket Set', 'It use for tighten bolts and nut and is the main part of wrench it like the bullet of wrench', './uploads/OIP (1).jpeg', 1000, 11, '2025-05-10'),
(10, 'Screwdrivers', 'It use to loosing nuts and it can be use tighten them when it is needed', './uploads/71bvsGSdbZL.jpg', 500, 13, '2025-05-10'),
(12, 'Ratcheting Wrench Set', 'A ratcheting wrench is a type of wrench that combines the standard wrench with a ratcheting mechanism on one end (usually the closed or box end). ', './uploads/spin_prod_240907901.jpeg', 800, 2, '2025-05-10'),
(13, 'Crowfoot Wrench Set', 'A crowfoot wrench is an open-end wrench head without a handle. Instead of a handle, it has a square hole so you can attach it to a ratchet, torque wrench, or extension bar.', './uploads/R.jpeg', 1000, 1, '2025-05-10'),
(14, 'Pry Bar', 'A pry bar (also called a lever bar or crowbar) is a strong metal tool designed to apply leverage to lift, move, or separate parts.', './uploads/61aY14E8BGL.jpg', 1000, 15, '2025-05-10');
